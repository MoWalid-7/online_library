<x-guest-layout>
        ...
        <div class="mt-4">
            ...
            <div style="position:relative;">
                ...
                <button type="button" onclick="togglePassword('password','eye-login')" tabindex="-1"
                    ...
                    <svg id="eye-login" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
    ...
    <p style="text-align:center; margin-top:1.5rem; font-size:0.875rem; color:#64748b;">
        ...
        <a href="{{ route('register') }}" style="color:#f59e0b; font-weight:600; text-decoration:none;">Create one →</a>
    </p>
</x-guest-layout>
